...
import utility.ExcelUtils;
    public class Search_Page012 extends BaseClass
    
    {
           private static WebElement element = null;
        
        public Search_Page012(WebDriver driver)
        {
            	super(driver);
        }     
        public static WebElement Search_results(int iTestCaseRow) throws Exception
        {
        	...
        	for (int i = 0; i < 500; i++)  
    		{
    			...
    			utility.ExcelWrite012.data.put(String.valueOf(i + 2), new Object[] {link, mcat});
    			}
