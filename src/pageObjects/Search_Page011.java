...
import utility.ExcelUtils;
    public class Search_Page011 extends BaseClass
    
    {
           private static WebElement element = null;
        
        public Search_Page011(WebDriver driver)
        {
            	super(driver);
        }     
        public static WebElement Search_results(int iTestCaseRow) throws Exception
        {
        	...
        	for (int i = 0; i < 500; i++)  
    		{
    			...
    			utility.ExcelWrite011.data.put(String.valueOf(i + 2), new Object[] {link, mcat});
    			}
