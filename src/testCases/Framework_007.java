...
import utility.ExcelWrite007;
import utility.Log;
import utility.Utils;
import appModules.SignIn_Action;
import appModules.Verification_Action007;

public class Framework_007{
  ...
  public void main() throws Exception {
	  ...
	  try{
		...
		Verification_Action007.Execute();
		...
		if(BaseClass.bResult==true){
			...
			ExcelWrite007.setCellData();
			System.out.println("ExcelWrite007 Data entered");
