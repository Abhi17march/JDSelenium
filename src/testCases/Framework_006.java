...
import utility.ExcelWrite006;
import utility.Log;
import utility.Utils;
import appModules.SignIn_Action;
import appModules.Verification_Action006;

public class Framework_006{
  ...
  public void main() throws Exception {
	  ...
	  try{
		...
		Verification_Action006.Execute();
		...
		if(BaseClass.bResult==true){
			...
			ExcelWrite006.setCellData();
			System.out.println("ExcelWrite006 Data entered");
