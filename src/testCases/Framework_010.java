...
import utility.ExcelWrite010;
import utility.Log;
import utility.Utils;
import appModules.SignIn_Action;
import appModules.Verification_Action010;

public class Framework_010{
  ...
  public void main() throws Exception {
	  ...
	  try{
		...
		Verification_Action010.Execute();
		...
		if(BaseClass.bResult==true){
			...
			ExcelWrite010.setCellData();
			System.out.println("ExcelWrite010 Data entered");
