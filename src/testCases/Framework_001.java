...
import utility.ExcelWrite001;
import utility.Log;
import utility.Utils;
import appModules.SignIn_Action;
import appModules.Verification_Action001;
...
public class Framework_001{
  ...
  public void main() throws Exception {
	  ...
	  try{
		...
		Verification_Action001.Execute();
		...
		if(BaseClass.bResult==true){
			...
			ExcelWrite001.setCellData();
			System.out.println("Data001 entered");
  ...
  String screenshot_path=utility.Utils.takeScreenshot(driver, sTestCaseName);
