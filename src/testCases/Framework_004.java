...
import utility.ExcelWrite004;
import utility.Log;
import utility.Utils;
import appModules.SignIn_Action;
import appModules.Verification_Action004;
...
public class Framework_004{
  ...
  public void main() throws Exception {
	  ...
	  try{
		...
		Verification_Action004.Execute();
		...
		if(BaseClass.bResult==true){
			...
			ExcelWrite004.setCellData();
			System.out.println("ExcelWrite004 Data entered");
