...
import utility.ExcelWrite002;
import utility.Log;
import utility.Utils;
import appModules.SignIn_Action;
import appModules.Verification_Action002;
...
public class Framework_002{
  ...
  public void main() throws Exception {
	  ...
	  try{
		...
		Verification_Action002.Execute();
		...
		if(BaseClass.bResult==true){
			...
			ExcelWrite002.setCellData();
			System.out.println("Data002 entered");
