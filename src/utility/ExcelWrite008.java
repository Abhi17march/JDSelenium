    ...
    public class ExcelWrite008 {
			...
			public static void setCellData() throws Exception{
                   
            	{
                   ...
                   XSSFSheet sheet = workbook.createSheet("008");
            		...
            		try {
            			FileOutputStream Out = new FileOutputStream(new File("D:\\JDLinks\\008.xlsx"));
            			workbook.write(Out);
                        System.out.println("Framwork008 data written successfully on disk.");
                        workbook.close();
                        Out.close();
            		}
